...
func TestGitCLIConfigEnv(t *testing.T) {
	...
	t.Run("isolated by default", func(t *testing.T) {
		...
		require.Contains(t, got, "HOME="+noConfigHome())
		require.Contains(t, got, "GIT_CONFIG_GLOBAL="+noConfigGlobal())
	...
	t.Run("host git config opt-in", func(t *testing.T) {
		...
		require.NotContains(t, got, "HOME="+noConfigHome())
		require.NotContains(t, got, "GIT_CONFIG_GLOBAL="+noConfigGlobal())
