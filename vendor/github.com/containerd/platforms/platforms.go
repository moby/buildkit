...
func NewMatcher(platform specs.Platform) Matcher {
	...
	if platform.OS == "windows" {
		m.osvM = &windowsVersionMatcher{
			windowsOSVersion: getWindowsOSVersion(winPrefix(platform.OSVersion)),
		}
		...
		//
		// TODO: This isn't actually used in this package at all, which may have been
		// an unintended side of some refactor.
		// I suspect that it was intended to be used in `Ordered` but it is not since
