...
func (e *localExporterInstance) Export(ctx context.Context, inp *exporter.Source, _ exptypes.InlineCache, sessionID string, apis exporter.ExporterAPIs) (map[string]string, exporter.DescriptorReference, error) {
