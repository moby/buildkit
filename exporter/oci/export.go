...
func (e *imageExporterInstance) Export(ctx context.Context, src *exporter.Source, inlineCache exptypes.InlineCache, sessionID string, apis exporter.ExporterAPIs) (_ map[string]string, descref exporter.DescriptorReference, err error) {
