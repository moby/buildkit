...
SLSA Provenance format (supports both [v0.2](https://slsa.dev/spec/v0.2/provenance) and [v1](https://slsa.dev/spec/v1.1/provenance)).
...
| SLSA version | Field                                                                          |
|--------------|--------------------------------------------------------------------------------|
| `v1`         | [`buildDefinition.buildType`](https://slsa.dev/spec/v1.1/provenance#buildType) |
| `v0.2`       | [`buildType`](https://slsa.dev/spec/v0.2/provenance#buildType)                 |
...
| SLSA version | Field                                                                                                         |
|--------------|---------------------------------------------------------------------------------------------------------------|
| `v1`         | [`buildDefinition.externalParameters.configSource`](https://slsa.dev/spec/v1.1/provenance#externalParameters) |
| `v0.2`       | [`invocation.configSource`](https://slsa.dev/spec/v0.2/provenance#invocation.configSource)                    |
...
object defines the context URL and its immutable digest in the `uri` and `digest`
fields. For builds using a local frontend, such as a Dockerfile, the
`entryPoint` (v0.2) or `path` (v1) field defines the path for the frontend file
that initialized the build (`filename` frontend option).

## `parameters`

| SLSA version | Field                                                                                                       |
|--------------|-------------------------------------------------------------------------------------------------------------|
| `v1`         | [`buildDefinition.externalParameters.parameters`](https://slsa.dev/spec/v1.1/provenance#externalParameters) |
| `v0.2`       | [`invocation.parameters`](https://slsa.dev/spec/v0.2/provenance#invocation.parameters)                      |
...
| SLSA version | Field                                                                                                        |
|--------------|--------------------------------------------------------------------------------------------------------------|
| `v1`         | [`buildDefinition.internalParameters.environment`](https://slsa.dev/spec/v1.1/provenance#internalParameters) |
| `v0.2`       | [`invocation.environment`](https://slsa.dev/spec/v0.2/provenance#invocation.parameters)                      |
...
| SLSA version | Field                                                                                                |
|--------------|------------------------------------------------------------------------------------------------------|
| `v1`         | [`buildDefinition.resolvedDependencies`](https://slsa.dev/spec/v1.1/provenance#resolvedDependencies) |
| `v0.2`       | [`materials`](https://slsa.dev/spec/v0.2/provenance#materials)                                       |
...
| SLSA version | Field                                                                                                        |
|--------------|--------------------------------------------------------------------------------------------------------------|
| `v1`         | [`buildDefinition.externalParameters.buildConfig`](https://slsa.dev/spec/v1.1/provenance#externalParameters) |
| `v0.2`       | [`buildConfig`](https://slsa.dev/spec/v0.2/provenance#buildConfig)                                           |
...
| SLSA version | Field                                                                                            |
|--------------|--------------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.invocationID`](https://slsa.dev/spec/v1.1/provenance#invocationId)         |
| `v0.2`       | [`metadata.buildInvocationId`](https://slsa.dev/spec/v0.2/provenance#metadata.buildInvocationId) |
...
| SLSA version | Field                                                                                         |
|--------------|-----------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.startedOn`](https://slsa.dev/spec/v1.1/provenance#startedOn)            |
| `v0.2`       | [`metadata.buildInvocationId`](https://slsa.dev/spec/v0.2/provenance#metadata.buildStartedOn) |
...
| SLSA version | Field                                                                                        |
|--------------|----------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.finishedOn`](https://slsa.dev/spec/v1.1/provenance#finishedOn)         |
| `v0.2`       | [`metadata.buildFinishedOn`](https://slsa.dev/spec/v0.2/provenance#metadata.buildFinishedOn) |
...
| SLSA version | Field                                                                                                                            |
|--------------|----------------------------------------------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.https://mobyproject.org/buildkit@v1#completeness`](https://slsa.dev/spec/v1.1/provenance#extension-fields) |
| `v0.2`       | [`metadata.completeness`](https://slsa.dev/spec/v0.2/provenance#metadata.completeness)                                           |
...
```json
    "runDetails": {
      "metadata": {
        "https://mobyproject.org/buildkit@v1#completeness": {
          "parameters": true,
          "environment": true,
          "materials": true
        },
...
| SLSA version | Field                                                                                                                            |
|--------------|----------------------------------------------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.https://mobyproject.org/buildkit@v1#reproducible`](https://slsa.dev/spec/v1.1/provenance#extension-fields) |
...
```json
    "runDetails": {
      "metadata": {
        "https://mobyproject.org/buildkit@v1#reproducible": false,
        ...
      },
    }
```
...
| SLSA version | Field                                                                                                                        |
|--------------|------------------------------------------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.https://mobyproject.org/buildkit@v1#hermetic`](https://slsa.dev/spec/v1.1/provenance#extension-fields) |
| `v0.2`       | `metadata.https://mobyproject.org/buildkit@v1#hermetic`                                                                      |
...
| SLSA version | Field                                                                                                                        |
|--------------|------------------------------------------------------------------------------------------------------------------------------|
| `v1`         | [`runDetails.metadata.https://mobyproject.org/buildkit@v1#metadata`](https://slsa.dev/spec/v1.1/provenance#extension-fields) |
| `v0.2`       | `metadata.https://mobyproject.org/buildkit@v1#metadata`                                                                      |
...
`configSource` field. But if the build uses a source from a local directory,
the VCS information is lost even if the directory contained a Git repository.
In this case, the build client can send additional `vcs:source` and
...
`configSource` field, BuildKit doesn't verify the `vcs` values, and as such
they can't be trusted and should only be used as a metadata hint.
