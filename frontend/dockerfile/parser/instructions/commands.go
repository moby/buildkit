...
//
// This is used by commands in slices instead of map[string]string to preserve
// ordering.
...
// The Command interface is implemented by every possible command in a Dockerfile.
//
...
type Stage struct {
	...
	Location   []ast.Range // location of the defining FROM command
}
