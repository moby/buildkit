...
func (x *ReadFileRequest) GetIndex() int32 {
	if x != nil {
		return x.Index
	}
	return 0
...
func (x *StatFileRequest) GetIndex() int32 {
	if x != nil {
		return x.Index
	}
	return 0
...
const file_github_com_moby_buildkit_frontend_gateway_pb_gateway_proto_rawDesc = "" +
	...
	"\x06result\x18\x03 \x01(\v2!.moby.buildkit.v1.frontend.ResultR\x06result\"\x91\x01\n" +
	"\x0fReadFileRequest\x12\x10\n" +
	"\x03Ref\x18\x01 \x01(\tR\x03Ref\x12\x1a\n" +
	"\bFilePath\x18\x02 \x01(\tR\bFilePath\x12:\n" +
	"\x05Range\x18\x03 \x01(\v2$.moby.buildkit.v1.frontend.FileRangeR\x05Range\x12\x14\n" +
	...
	"\x0eIncludePattern\x18\x03 \x01(\tR\x0eIncludePattern\x12\x14\n" +
	"\x05Index\x18\x04 \x01(\x05R\x05Index\"?\n" +
	"\x0fReadDirResponse\x12,\n" +
	"\aentries\x18\x01 \x03(\v2\x12.fsutil.types.StatR\aentries\"M\n" +
