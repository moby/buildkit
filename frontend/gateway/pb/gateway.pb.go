...
type Attestation_Kind int32

const (
	Attestation_InToto Attestation_Kind = 0
)

var Attestation_Kind_name = map[int32]string{
	0: "InToto",
}

var Attestation_Kind_value = map[string]int32{
	"InToto": 0,
}

func (x Attestation_Kind) String() string {
	return proto.EnumName(Attestation_Kind_name, int32(x))
}

func (Attestation_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f1a937782ebbded5, []int{5, 0}
}

type InTotoSubject_Kind int32

const (
	InTotoSubject_Raw  InTotoSubject_Kind = 0
	InTotoSubject_Self InTotoSubject_Kind = 1
)

var InTotoSubject_Kind_name = map[int32]string{
	0: "Raw",
	1: "Self",
}

var InTotoSubject_Kind_value = map[string]int32{
	"Raw":  0,
	"Self": 1,
}

func (x InTotoSubject_Kind) String() string {
	return proto.EnumName(InTotoSubject_Kind_name, int32(x))
}

func (InTotoSubject_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f1a937782ebbded5, []int{6, 0}
}
...
type Attestation struct {
	Kind                 Attestation_Kind `protobuf:"varint,1,opt,name=kind,proto3,enum=moby.buildkit.v1.frontend.Attestation_Kind" json:"kind,omitempty"`
...
func (m *Attestation) GetKind() Attestation_Kind {
	if m != nil {
		return m.Kind
	}
	return Attestation_InToto
}
...
type InTotoSubject struct {
	Kind                 InTotoSubject_Kind                           `protobuf:"varint,1,opt,name=kind,proto3,enum=moby.buildkit.v1.frontend.InTotoSubject_Kind" json:"kind,omitempty"`
	RawDigest            []github_com_opencontainers_go_digest.Digest `protobuf:"bytes,2,rep,name=rawDigest,proto3,customtype=github.com/opencontainers/go-digest.Digest" json:"rawDigest"`
	RawName              string                                       `protobuf:"bytes,3,opt,name=rawName,proto3" json:"rawName,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                     `json:"-"`
	XXX_unrecognized     []byte                                       `json:"-"`
	XXX_sizecache        int32                                        `json:"-"`
}
...
func (m *InTotoSubject) GetKind() InTotoSubject_Kind {
	if m != nil {
		return m.Kind
	}
	return InTotoSubject_Raw
}

func (m *InTotoSubject) GetRawName() string {
	if m != nil {
		return m.RawName
	}
	return ""
...
func init() {
	proto.RegisterEnum("moby.buildkit.v1.frontend.Attestation_Kind", Attestation_Kind_name, Attestation_Kind_value)
	proto.RegisterEnum("moby.buildkit.v1.frontend.InTotoSubject_Kind", InTotoSubject_Kind_name, InTotoSubject_Kind_value)
...
var fileDescriptor_f1a937782ebbded5 = []byte{
	...
	,
}
...
func (m *InTotoSubject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RawDigest) > 0 {
		for iNdEx := len(m.RawDigest) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.RawDigest[iNdEx])
			copy(dAtA[i:], m.RawDigest[iNdEx])
			i = encodeVarintGateway(dAtA, i, uint64(len(m.RawDigest[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Kind |= Attestation_Kind(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Kind |= InTotoSubject_Kind(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawDigest", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RawDigest = append(m.RawDigest, github_com_opencontainers_go_digest.Digest(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RawName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGateway(dAtA[iNdEx:])
