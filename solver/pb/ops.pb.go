...
func (m *CopyOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CopyOp.Merge(m, src)
}
...
func (m *CopySource) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CopySource.Merge(m, src)
}
