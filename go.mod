...
// Test https://github.com/containerd/containerd/pull/8220
replace github.com/containerd/containerd => github.com/AkihiroSuda/containerd v1.7.0-rc.1.0.20230307170440-d26587c725d1
