...
// FIXME(thaJeztah): testing https://github.com/docker/cli/pull/5244
replace github.com/docker/cli => github.com/laurazard/cli v0.0.0-20240718081616-e29092a9e50a
