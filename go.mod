...
replace (
	github.com/containerd/fuse-overlayfs-snapshotter v1.0.2 => github.com/dmcgowan/fuse-overlayfs-snapshotter v0.0.0-20240206055847-7a9f81e314b8
	github.com/containerd/stargz-snapshotter v0.14.3 => github.com/dmcgowan/stargz-snapshotter v0.0.0-20240207221841-cf5398ca3072
)
