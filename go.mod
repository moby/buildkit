...
require (
	...
	github.com/docker/cli v27.3.2-0.20241008150905-cb3048fbebb1+incompatible // 27.x branch (v27.4.0-dev)
	github.com/docker/docker v27.3.2-0.20241012140734-fb64e14bbf7d+incompatible // 27.x branch (v27.4.0-dev)
